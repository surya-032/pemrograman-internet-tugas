document.addEventListener('DOMContentLoaded', function () {
    ...
    tanggalInput.addEventListener('blur', validateTanggal); // Tambahkan ini
    ...
    function validateForm() {
        ...
        if (!validateTanggal()) { // Tambahkan ini
            isValid = false;
        }
        if (!validateUsia()) {
            isValid = false;
        ...
        if (isValid) {
            alert('Data Form Berhasil Disubmit!');
            form.submit();
        }
    }
    ...
    function validateTanggal() {
        ...
        if (tanggalValue === '') {
            tanggalError.textContent = 'Tanggal lahir harus diisi.';
            return false;
        }
    ...
    function validateProgramStudi() {
        ...
        if (selectedValue === '') {
            ...
            return false;
        } else if (selectedValue === 'Pilih Program Studi') {
            programStudiError.textContent = 'Pilih program studi yang valid.';
            return false;
        }
